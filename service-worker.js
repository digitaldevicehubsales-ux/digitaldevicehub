const CACHE='ddh-v37';
const ASSETS=['/','/index.html','/site-v2.css','/config.js','/countries.js','/app.js','/home-preview-fix.js','/auth-ui.js','/account-ui.js','/localization.js','/locale-picker.js','/locale-ui.js','/analytics.js','/role-router.js','/open-signin.js','/mobile-nav.js','/marketplace.html','/marketplace-page.js','/marketplace-engagement.js','/device.html','/device-shell.html','/device-page.js','/device-state-fix.js','/sell.html','/sell-wizard.js','/seller.html','/seller-page.js','/trust.html','/help.html','/about.html','/contact.html','/phones.html','/laptops.html','/tablets.html','/accessories.html','/wearables.html','/compare.html','/compare.js','/404.html','/dashboard.html','/dashboard.js','/dashboard-engagement.js','/director-link.js','/director.html','/director.css','/director-ux.css','/director.js','/director-ux.js','/admin.html','/admin.css','/admin.js','/admin-v2.js','/manifest.webmanifest','/favicon.svg','/resend-confirmation.html','/resend-confirmation.js'];
